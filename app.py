...
def search_callback():
    permanent_csv_url = "https://raw.githubusercontent.com/tmtsmrsl/TwitterSentimentAnalyzer/main/dataset/labeled_tweets.csv"

    st.session_state.df = hf.get_latest_tweet_df(
        permanent_csv_url, st.session_state.search_term, st.session_state.num_tweets
    )
...
with st.sidebar:
    ...
    st.markdown("Created by Sukhmandeep Singh and Deepanshu Thakur")
